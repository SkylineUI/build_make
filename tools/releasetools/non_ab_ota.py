...
""" % bcb_dev)
  ...
  build_date = target_info.GetBuildProp("org.skylineui.build_date")
  security_patch = target_info.GetBuildProp("ro.build.version.security_patch")
  device = target_info.GetBuildProp("org.skylineui.device")
  script.PrintSkylineUIBanner(android_version, build_id, build_date,
